...
export function CTASection() {
  return (
    <div className="py-16 sm:py-24">
      <Container>
        <div className="relative isolate overflow-hidden bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-16 shadow-2xl sm:rounded-3xl sm:px-16 md:py-24 lg:flex lg:gap-x-20 lg:px-24">
          ...
          <div className="relative mt-16 h-80 lg:mt-0">
            <FadeIn delay={300}>
              <div className="absolute left-0 top-0 w-full h-full bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-white text-lg font-semibold">Get in Touch</p>
                    <p className="mt-2 text-blue-100">info@techpro.com</p>
